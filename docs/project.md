...
# Current Focus
None chosen yet. Serving-size selector + parts ratio view is **complete** as of 2026-09-05 - all 5 stages done, browser-verified on a real iPhone across every stage, plus a same-day fix for a real "top-up part" data-corruption bug found live after Stage 5 (164/164 automated tests passing). Pick the next focus from Next/Backlog below.
...
# Backlog
(empty - serving-size selector, the only entry, shipped 2026-09-05; see Decisions below and current-context.md for the full build record)
