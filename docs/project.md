...
# Backlog
1. Cocktail Library + My Bar UX improvements - Stage 1 done (see Current Focus). Stages 2-5 (Library grouped view; ingredient/bottle detail screen + route; My Bar tap-to-view wiring, kept separate from Build Your Bar's tap-to-select; final docs/regression) not started.
